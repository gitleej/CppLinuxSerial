...
namespace mn {
    namespace CppLinuxSerial {
        ...
        enum class NumDataBits : unsigned int{
            FIVE = 5,
            SIX = 6,
            SEVEN = 7,
            EIGHT = 8,
